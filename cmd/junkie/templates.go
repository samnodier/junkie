    ...
    <section class="profile-page profile-stack">
      ...
      <article class="panel profile-card">
        ...
        <form class="profile-password-form" method="post" action="/profile/password">
          ...
          <label>New password <input type="password" name="new_password" autocomplete="new-password" required minlength="6"></label>
          <label>Confirm new password <input type="password" name="confirm_password" autocomplete="new-password" required minlength="6"></label>
      ...
      <article class="panel profile-card">
        ...
        <div class="profile-preference">
          <div>
            ...
            {{if .DiscordLinked}}
            <p class="muted">Connected as <span class="mono">@{{.DiscordUsername}}</span>. Use <span class="mono">/junkie</span> commands in servers running the junkie bot. <a href="https://discord.com/oauth2/authorize?client_id=1526585859044933684&amp;scope=bot+applications.commands&amp;permissions=2048" target="_blank" rel="noopener">Add the bot to a server</a>.</p>
            {{else}}
            <p class="muted">Not connected. In a server with the junkie bot, run <span class="mono">/junkie link</span> and open the link it gives you. <a href="https://discord.com/oauth2/authorize?client_id=1526585859044933684&amp;scope=bot+applications.commands&amp;permissions=2048" target="_blank" rel="noopener">Add the bot to a server</a>.</p>
            {{end}}
          </div>
          {{if .DiscordLinked}}
