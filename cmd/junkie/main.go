...
func (a *app) signupForm(w http.ResponseWriter, r *http.Request) {
	a.render(w, "signup", pageData{Title: "Create account", Next: safeNext(r.URL.Query().Get("next"))})
}
...
func (a *app) signup(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		a.render(w, "signup", pageData{Title: "Create account", Next: next, Error: "That username is already taken."})
		return
	}
...
func (a *app) loginForm(w http.ResponseWriter, r *http.Request) {
	a.render(w, "login", pageData{Title: "Log in", Next: safeNext(r.URL.Query().Get("next"))})
}
...
func (a *app) login(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil || bcrypt.CompareHashAndPassword([]byte(hash), []byte(password)) != nil {
		a.render(w, "login", pageData{Title: "Log in", Next: next, Error: "Username or password is incorrect."})
		return
	}
	a.createSession(w, r, id)
	http.Redirect(w, r, next, http.StatusSeeOther)
